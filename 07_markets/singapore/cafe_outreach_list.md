# SHIZUNE MATCHA — シンガポール カフェ営業リスト（抹茶ラテ提供店）

作成日: 2026-08-25
目的: 抹茶ラテを提供するSGカフェへのB2B（バルクCeremonial）卸提案
注意: **連絡先は捏造していません。** 実在確認できたエリア/店舗のみ記載。連絡先は各店のIG/サイト/店頭で最終確認のこと。

---

## 営業の考え方（重要）

抹茶ラテ提供店は2タイプに分かれ、**当たりやすさが大きく違う**。

- **A｜独立系スペシャルティカフェ**（抹茶を“1メニューの材料”として仕入れる）
  → 新規サプライヤーに前向き。**最優先ターゲット**。多店舗展開は数量も見込める。
- **B｜抹茶ブランド専門店**（自前の宇治/京都抹茶で差別化）
  → 抹茶が“看板”。切替ハードル高く、競合になりがち。**低優先**（挨拶程度）。

**アプローチ**: まずIG DM（オーナー/店長）か問い合わせフォーム → 無償サンプル提案 → B2Bデッキ（カフェ版：小売スライド非表示）を送付。
...
| # | Café | エリア / 店舗 | メモ |
|---|------|--------------|------|
| 9 | Hvala | Somerset / Odeon Towers / Takashimaya | 京都ceremonialを目の前で点てる。自社ブランド色強い |
| 10 | Matchaya | Takashimaya #03-10A / CapitaSpring / Suntec / Changi T3 | 2015〜の地元パイオニア。宇治ソフト |
| 11 | Tsujiri | Clarke Quay Central / Holland Village | 京都老舗（1860〜）。自前ブランド |
...
1. 優先度Aの8店について、**IG/公式サイトで連絡先（DM可否・問い合わせフォーム・卸窓口）を確認**して連絡先列を埋める
2. カフェ版デッキ（P10小売スライド非表示）＋無償サンプル提案の英文DM/メール雛形を用意（希望あれば作成）
3. 送信ログを本フォルダに `outreach_log.md` として記録（US同様の運用）

## 出典（一次リサーチ）
- eatbook.sg「10 Best Matcha Cafes」／danielfooddiary.com／districtsixtyfive.com／thehoneycombers.com／nani.sg／timeout.com／thepeakmagazine.com.sg（2025–2026）
※ 店舗・住所・営業状況は変わりやすいため、送信前に各店の最新情報を確認すること。
